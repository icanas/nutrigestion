...
ON dia (desayuno, postdesayuno, comida, merienda, cena);
...
ALTER TABLE `dieta`
    ...
    ADD CONSTRAINT `dieta_ibfk_2` FOREIGN KEY (`lunes`) REFERENCES `dia` (`id`),
    ADD CONSTRAINT `dieta_ibfk_3` FOREIGN KEY (`martes`) REFERENCES `dia` (`id`),
    ADD CONSTRAINT `dieta_ibfk_4` FOREIGN KEY (`miercoles`) REFERENCES `dia` (`id`),
    ADD CONSTRAINT `dieta_ibfk_5` FOREIGN KEY (`jueves`) REFERENCES `dia` (`id`),
    ADD CONSTRAINT `dieta_ibfk_6` FOREIGN KEY (`viernes`) REFERENCES `dia` (`id`),
    ADD CONSTRAINT `dieta_ibfk_7` FOREIGN KEY (`sabado`) REFERENCES `dia` (`id`),
    ADD CONSTRAINT `dieta_ibfk_8` FOREIGN KEY (`domingo`) REFERENCES `dia` (`id`);


ALTER TABLE `dia`
  ADD CONSTRAINT `dia_ibfk_1` FOREIGN KEY (`postdesayuno`) REFERENCES `comida` (`id`),
  ADD CONSTRAINT `dia_ibfk_2` FOREIGN KEY (`postdesayuno`) REFERENCES `comida` (`id`),
  ADD CONSTRAINT `dia_ibfk_3` FOREIGN KEY (`comida`) REFERENCES `comida` (`id`),
  ADD CONSTRAINT `dia_ibfk_4` FOREIGN KEY (`merienda`) REFERENCES `comida` (`id`),
  ADD CONSTRAINT `dia_ibfk_5` FOREIGN KEY (`cena`) REFERENCES `comida` (`id`);


ALTER TABLE `comida`
  ADD CONSTRAINT `comida_ibfk_1` FOREIGN KEY (`idAlimento`) REFERENCES `alimento` (`id`);
